...
public class KlineBarEntry extends BarEntry implements Cloneable{
    ...
    @Override
    public KlineBarEntry clone() {
        KlineBarEntry stu = null;
        try{
            stu = (KlineBarEntry)super.clone();
     ...
     * @param xIndex
     */
    public KlineBarEntry(float[] vals, int xIndex) {
     ...
     */
    public KlineBarEntry(int xIndex, float shadowH, float shadowL, float open, float close, float val) {
        super(val,xIndex);
     ...
     * @param xIndex
     */
    public KlineBarEntry(float val, int xIndex) {
        super(val, xIndex);
    }
     ...
     */
    public KlineBarEntry(float[] vals, int xIndex, String label) {
     ...
     */
    public KlineBarEntry(float val, int xIndex, Object data) {
