...
public class BMOrdersAdapter extends BaseAdapter<OrderBean> {
    ...
    public BMOrdersAdapter(Context context, List<OrderBean> datas) {
        super(context, R.layout.adapter_bm_order, datas);
