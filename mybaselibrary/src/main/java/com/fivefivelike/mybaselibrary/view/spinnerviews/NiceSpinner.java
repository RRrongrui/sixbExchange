package com.fivefivelike.mybaselibrary.view.spinnerviews;
...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.trans_20px);

        // setGravity(Gravity.CENTER_VERTICAL | Gravity.START);
        setPadding(resources.getDimensionPixelSize(R.dimen.trans_40px), defaultPadding, defaultPadding,
                defaultPadding);
        setClickable(true);
        ...
        if (typedArray.getResourceId(R.styleable.NiceSpinner_textTint, INVALID_ID) != INVALID_ID) {
            textColor = SkinCompatResources.getColor(context, typedArray.getResourceId(R.styleable.NiceSpinner_textTint, INVALID_ID));
        }
