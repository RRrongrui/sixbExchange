...
package com.fivefivelike.mybaselibrary.view.roundcornerprogressbar;
...
import com.fivefivelike.mybaselibrary.view.roundcornerprogressbar.common.BaseRoundCornerProgressBar;
...
public class IconRoundCornerProgressBar extends BaseRoundCornerProgressBar implements View.OnClickListener {
    ...
    protected void initStyleable(Context context, AttributeSet attrs) {
        ...
        int colorIconBackgroundDefault = context.getResources().getColor(R.color.color_555555);
