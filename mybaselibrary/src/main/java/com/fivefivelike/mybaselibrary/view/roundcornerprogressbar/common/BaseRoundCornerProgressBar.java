...
package com.fivefivelike.mybaselibrary.view.roundcornerprogressbar.common;
...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        int colorBackgroundDefault = context.getResources().getColor(R.color.color_555555);
        colorBackground = typedArray.getColor(R.styleable.RoundCornerProgress_rcBackgroundColor, colorBackgroundDefault);
        int colorProgressDefault = context.getResources().getColor(R.color.color_666666);
