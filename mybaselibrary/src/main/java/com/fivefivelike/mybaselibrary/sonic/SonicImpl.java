package com.fivefivelike.mybaselibrary.sonic;
...
public class SonicImpl {
    ...
    public void onCreateSession() {
        ...
        SonicEngine.createInstance(new DefaultSonicRuntimeImpl(GlobleContext.getInstance().getApplicationContext()), new SonicConfig.Builder().build());
