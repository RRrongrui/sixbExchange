...
public final class CircleDialog {
    ...
    public interface CircleDialogLinsener {
    ...
    private CircleDialog(CircleDialog.CircleDialogLinsener circleDialogLinsener) {
    ...
    public DialogFragment create(CircleParams params) {
        if (mDialog == null) {
            ...
            if (circleDialogLinsener != null) {
                mDialog.setCircleDialogLinsener(circleDialogLinsener);
            }
        } else {
    ...
    public static class Builder {
        ...
        private CircleDialogLinsener circleDialogLinsener;
        ...
        public Builder setCircleDialogLinsener(CircleDialogLinsener circleDialogLinsener) {
            this.circleDialogLinsener = circleDialogLinsener;
            return this;
        }
        ...
        public DialogFragment create() {
            if (mCircleDialog == null) {
                mCircleDialog = new CircleDialog(circleDialogLinsener);
            }
