 ...
 */
public class SlidingTabLayout extends SkinHorizontalScrollView implements ViewPager.OnPageChangeListener, SkinCompatSupportable {
    ...
    private int mIndicatorId = 0;
    private Drawable mIndicatorDrawableImg;
    /**
     * underline
     */
    ...
    public void setViewPager(ViewPager vp, String[] titles,
        ...
        this.mViewPager.setAdapter(
                new InnerPagerAdapter(fa.getSupportFragmentManager(),
                        fragments, titles));
    ...
    public void setViewPager(ViewPager vp, String[] titles,
                             Fragment fa, ArrayList<Fragment> fragments) {
        if (vp == null) {
            throw new IllegalStateException("ViewPager can not be NULL !");
        }
        ...
        this.mViewPager = vp;
        this.mViewPager.setAdapter(new InnerPagerAdapter(fa.getChildFragmentManager(),
                fragments, titles));
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        if (tv_tab_title != null) {
            if (title != null)
                tv_tab_title.setText(Html.fromHtml(title));
        }
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tv_tab_title != null) {
                ...
                if (mTextAllCaps) {
                    tv_tab_title.setText(Html.fromHtml(tv_tab_title.getText().toString().toUpperCase()));
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorId != 0) {
                if (mIndicatorDrawableImg == null) {
                    mIndicatorDrawableImg = getResources().getDrawable(mIndicatorId);
                }
                if (mIndicatorGravity == Gravity.BOTTOM) {
                    mIndicatorDrawableImg.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
